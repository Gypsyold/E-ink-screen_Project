...
#define EPD_SCL_SPI_CLK			RCC_APB2Periph_SPI1

#define EPD_SDA_GPIO_PORT		GPIOA
#define EPD_SDA_GPIO_PIN		GPIO_Pin_7	
#define EPD_SDA_GPIO_CLK		RCC_APB2Periph_GPIOA
#define EPD_SDA_SPI_CLK			RCC_APB2Periph_SPI1

#define EPD_RES_GPIO_PORT		GPIOA
#define EPD_RES_GPIO_PIN		GPIO_Pin_1	
#define EPD_RES_GPIO_CLK		RCC_APB2Periph_GPIOA

#define EPD_DC_GPIO_PORT		GPIOA
#define EPD_DC_GPIO_PIN			GPIO_Pin_2	
#define EPD_DC_GPIO_CLK			RCC_APB2Periph_GPIOA

#define EPD_CS_GPIO_PORT		GPIOA
#define EPD_CS_GPIO_PIN			GPIO_Pin_3	
#define EPD_CS_GPIO_CLK			RCC_APB2Periph_GPIOA

#define EPD_BUSY_GPIO_PORT		GPIOA
#define EPD_BUSY_GPIO_PIN		GPIO_Pin_4	
#define EPD_BUSY_GPIO_CLK		RCC_APB2Periph_GPIOA
...
void SPI_Configuration(void);	//硬件SPI初始化
