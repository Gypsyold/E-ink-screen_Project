...
void Paint_SetPixel(u16 Xpoint,u16 Ypoint,u16 Color);								//点亮一个像素点
void Paint_Clear(u8 Color);															//清空缓冲区
...
void EPD_ShowFloatNum1(u16 x,u16 y,float num,u8 len,u8 pre,u8 sizey,u8 color);		//显示浮点型数字
...
void EPD_InvertRect(u8 *image, u16 x, u16 y, u16 w, u16 h);		//指定区域取反
